...
texinfo_documents = [
    ('index', 'RAISA', u'RAISA Website', 'RAISA, Second_Fry', 'RAISA',
     'Documentation related for running high-sec incursions via RAISA Shield', 'Miscellaneous'),
]
